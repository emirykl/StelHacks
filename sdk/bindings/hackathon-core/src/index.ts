...
export const Errors = {
  ...
  3: {message:"NotOrganizer"},
  4: {message:"NotOnOrganizingTeam"},
  5: {message:"NotJudge"},
  6: {message:"NotTeamMember"},
  7: {message:"NotVault"},
  8: {message:"CollaboratorAlreadyAdded"},
  9: {message:"CollaboratorNotFound"},
  10: {message:"OrganizerCannotBeCollaborator"},
  11: {message:"VaultAlreadyBound"},
  12: {message:"VaultNotBound"},
  13: {message:"VaultServesAnotherHackathon"},
  14: {message:"VaultHoldsTheWrongAsset"},
  20: {message:"TrackNotFound"},
  21: {message:"TrackAlreadyExists"},
  22: {message:"CriteriaWeightsInvalid"},
  23: {message:"CriteriaMissing"},
  24: {message:"JudgeAlreadyAssigned"},
  25: {message:"JudgeNotAssigned"},
  26: {message:"JudgeQuorumInvalid"},
  27: {message:"VoteSplitInvalid"},
  28: {message:"PrizeTiersInvalid"},
  29: {message:"TieBreakInvalid"},
  30: {message:"DisqualificationThresholdInvalid"},
  31: {message:"AppealWindowInvalid"},
  32: {message:"SettlementWindowInvalid"},
  33: {message:"ClaimPeriodInvalid"},
  34: {message:"RefundRouteInvalid"},
  35: {message:"CancellationThresholdInvalid"},
  36: {message:"TracksMissing"},
  37: {message:"JudgesMissing"},
  38: {message:"VisibilityConflictsWithVote"},
  39: {message:"NoAwardRefundNeedsAnotherTrack"},
  50: {message:"TeamPolicyInvalid"},
  40: {message:"WrongPhase"},
  41: {message:"PhaseOrderInvalid"},
  42: {message:"RulesAlreadyLocked"},
  43: {message:"RulesNotLocked"},
  44: {message:"DeadlineNotReached"},
  45: {message:"DeadlinePassed"},
  46: {message:"ScheduleInvalid"},
  47: {message:"DeadlineCannotShorten"},
  48: {message:"ExtensionLimitReached"},
  49: {message:"ExtensionPolicyInvalid"},
  60: {message:"ApplicationNotFound"},
  61: {message:"ApplicationAlreadyExists"},
  62: {message:"ApplicationAlreadyDecided"},
  63: {message:"NotApproved"},
  71: {message:"TeamNotFound"},
  72: {message:"TeamIsFull"},
  73: {message:"MemberAlreadyInTeam"},
  74: {message:"AlreadyOnAnotherTeam"},
  75: {message:"NotTeamCaptain"},
  64: {message:"SubmissionNotFound"},
  65: {message:"SubmissionAlreadyExists"},
  66: {message:"SubmissionNotEligible"},
  67: {message:"ProjectNameMissing"},
  68: {message:"RepositoryLinkRequired"},
  69: {message:"DemoVideoLinkRequired"},
  70: {message:"LiveUrlRequired"},
  80: {message:"ScorecardAlreadyRecorded"},
  88: {message:"ScorecardIncomplete"},
  89: {message:"AlreadyRecused"},
  90: {message:"NotTheSealer"},
  91: {message:"WrongJudgingMode"},
  92: {message:"ProofDoesNotMatchRoot"},
  81: {message:"ScorecardNotFound"},
  82: {message:"ScoreOutOfRange"},
  83: {message:"JudgeRecused"},
  84: {message:"ScoreRootAlreadyPublished"},
  85: {message:"ScoreRootMissing"},
  86: {message:"RevealDoesNotMatchRoot"},
  87: {message:"JudgeQuorumNotMet"},
  100: {message:"VoterNotEligible"},
  101: {message:"VoteAlreadyCast"},
  102: {message:"SelfVoteRejected"},
  103: {message:"CommunityVoteDisabled"},
  104: {message:"BallotRootAlreadyPublished"},
  105: {message:"BallotRootMissing"},
  106: {message:"BallotAlreadyCounted"},
  120: {message:"AlreadyInvalidated"},
  121: {message:"DisqualificationAlreadyOpen"},
  122: {message:"DisqualificationNotOpen"},
  123: {message:"AppealWindowOpen"},
  124: {message:"AppealWindowClosed"},
  125: {message:"JudgeApprovalThresholdNotMet"},
  126: {message:"AlreadySigned"},
  127: {message:"DisqualificationUnresolved"},
  140: {message:"ResultsAlreadyFinalized"},
  141: {message:"ResultsNotFinalized"},
  142: {message:"NoAwardNotDeclarable"},
  143: {message:"SettlementPaused"},
  144: {message:"SettlementNotPaused"},
  145: {message:"SafetyWindowOpen"},
  146: {message:"PrizeAlreadyPaid"},
  147: {message:"VaultUnderfunded"},
  148: {message:"NoAwardAlreadyOpen"},
  149: {message:"NoAwardNotOpen"},
  150: {message:"NoAwardAlreadyResolved"},
  151: {message:"ClaimPeriodOpen"},
  152: {message:"SettlementIncomplete"},
  160: {message:"CancellationAlreadyOpen"},
  161: {message:"CancellationNotOpen"}
}
 ...
 */
export type DataKey = {tag: "Organizers", values: void} | {tag: "Constitution", values: void} | {tag: "ConstitutionHash", values: void} | {tag: "State", values: void} | {tag: "Extensions", values: readonly [Deadline]} | {tag: "Vault", values: void} | {tag: "Registration", values: readonly [string]} | {tag: "Team", values: readonly [u32]} | {tag: "TeamCount", values: void} | {tag: "Membership", values: readonly [string]} | {tag: "Submission", values: readonly [u32]} | {tag: "Cancellation", values: void} | {tag: "CancellationApproval", values: readonly [string]} | {tag: "Disqualification", values: readonly [u32]} | {tag: "DisqualificationApproval", values: readonly [u32, string]} | {tag: "Recusal", values: readonly [string, u32]} | {tag: "RecusalCount", values: readonly [u32]} | {tag: "ScoreRoot", values: void} | {tag: "Score", values: readonly [u32, string]} | {tag: "ScoreTally", values: readonly [u32]} | {tag: "BallotRoot", values: void} | {tag: "BallotCounted", values: readonly [string]} | {tag: "VoteCount", values: readonly [u32]} | {tag: "TopVoteCount", values: void} | {tag: "CriterionTally", values: readonly [u32, string]} | {tag: "Ranking", values: readonly [string]} | {tag: "Paid", values: readonly [string, u32]} | {tag: "NoAward", values: readonly [string]} | {tag: "NoAwardApproval", values: readonly [string, string]};
...
export interface Client {
   ...
   */
  settle_prize: ({track, rank}: {track: string, rank: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<i128>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
        ...
        "",
